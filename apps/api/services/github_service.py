...
async def get_user_stats(username: str, token: str) -> dict[str, Any]:
    ...
    return {
        ...
        "total_commit_contributions": contrib_collection.get("totalCommitContributions", 0),
        "total_issue_contributions": contrib_collection.get("totalIssueContributions", 0),
        "total_pull_request_contributions": contrib_collection.get("totalPullRequestContributions", 0),
