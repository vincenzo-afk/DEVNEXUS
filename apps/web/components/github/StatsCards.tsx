...
function StatCard({ icon, label, value, change, changeLabel, color, delay, suffix }: StatCardProps) {
  ...
  return (
    <motion.div
      ...
      className="stat-card glass-card rounded-2xl p-5 border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer group relative overflow-hidden bg-white/3 backdrop-blur-md"
    >
      {/* Background glow */}
      <div
